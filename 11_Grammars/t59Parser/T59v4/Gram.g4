...
startRule
    : program (PROGRAM_SEPARATOR program)* EOF
    ;
...
atomic_statement: 
    ...
    | inv=I22_invert? sta=(I23_ln|I28_log|I30_tan|I37_polar_to_rectangular|I38_sin|I39_cos|I45_power|I52_exponent|I57_engineering|I58_fix|I59_integer|I78_sigma_plus|I79_average|I88_dms|I90_list|I96_write)
    ;

d_statement: 
    sta=(I36_program|I42_store|I43_recall|I48_exchange|I82_hir) t=(D1|D2)   // direct, non-invertible
...
i_statement:
    ...
    | sta=(I36_program|I42_store|I43_recall|I48_exchange|I69_operation) ind=I40_indirect t=(D1|D2)   // Non-invertible statements that use Ind
