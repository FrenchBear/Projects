...
//
// Contrary to some emulators, don't support 2nd as a prefix as in 2nd CLR, I use CLR' instead, 2nd 1/x is tan, ...
// This wouldn't be difficult but it's only needed for an emulator that supports 2nd key
//
// 2025-11-22   PV
...
I35_reciprocal: '1/x';
I36_program: 'Pgm';
I37_polar_to_rectangular: 'P→R' | 'P->R' | 'P/R' | 'P-R';
I38_sin: 'sin';
I39_cos: 'cos';
I40_indirect: 'Ind';
