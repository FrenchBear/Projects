...
// 2025-11-15   PV      Experiments on v3, naming elements using #, but so far benefit is not clear
...
memory:         d d? #DMemory;                                           // Register number
indmemory:      d d? #DIndirectMemory;                                           // Indirect Register number
pgm_number:     d d? #DPgmNumber;
address_label:  ((d d d)|('0' d WS d d)) #DAddressLabel;                         // The version nn<space>nn is for T59 programs
numeric_key_label: ('1'|'2'|'3'|'4'|'5'|'6'|'7'|'8'|'9') d;     // 10..99, an extension as a substitute to keys labels (25=CLR)
op_number:      ((('0'|'1'|'2'|'3') d) | ('4' '0')) #DOpNumber;  
...
instruction_memory
    : I42_store WS? memory_or_indirect          # J1
	| I43_recall WS? memory_or_indirect         # J2
	| I48_exchange WS? memory_or_indirect       # J3
	| I82_hir WS? memory                        # J4
	| I72_store_indirect WS? indmemory          # J5
	| I73_recall_indirect WS? indmemory         # J6
	| I63_exchange_indirect WS? indmemory       # J7
	| inv? I44_sum WS? memory_or_indirect       # J8
	| inv? I49_product WS? memory_or_indirect   # J9
	| inv? I74_sum_indirect WS? indmemory       # J10
	| inv? I64_product_indirect WS? indmemory   # J11
    ;
