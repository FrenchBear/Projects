...
public partial class LSystemForm: Form
{
    ...
    public LSystemForm()
    {
        ...
        SmoothingMethodsComboBox.Items.AddRange([
        ...
        var Internal = new List<LSystem> {
            new("HilbertDonut", "Hilbert curve on a circle", 4, "XFXFXFXF", "X=-YF+XFX+FY-\r\nY=+XF-YFY-FX+"),
            new("Dragon", "Original Dragon curve", 8, "FX", "F=\r\nX=-FX++FY-\r\nY=+FX--FY+"),
            new("Hilbert", "Basic Hilbert curve", 4, "X", "X=-YF+XFX+FY-\r\nY=+XF-YFY-FX+"),
            new("Flocon", "Von Koch curve", 6, "F", "F=F-F++F-F"),
            new("F5", "Carré 5x5", 4, "α315F", "F=@2F-F+@I2>1F+F-F+F+<1@2F-F@I2>1-F-F+F-F+F<1"),
            new("F3", "Carré 3x3", 4, "α45F", "F=F-F+F+F+F-F-F-F+F"),
            new("Alternatif", "Courant alternatif carré", 4, "F", "F=F-F+F+FF-F-F+F"),
            new("Triangle", "Triangle évidé", 6, "--X", "X=++FXF++FXF++FXF>1\r\nF=FF"),
            new("Penrose", "Color Penrose", 10, "+WC02F--XC04F---YC04F--ZC02F", "W=YC04F++ZC02F----XC04F[-YC04F----WC02F]++\r\nX=+YC04F--ZC02F[---WC02F--XC04F]+\r\nY=-WC02F++XC04F[+++YC04F++ZC02F]-\r\nZ=--YC04F++++WC02F[+ZC02F++++XC04F]--XC04F\n\rF="),
            new("Hexa", "Hexagonal fractal (ma propre version)", 6, "α210X", "X=XF-YF--YF+XF++XFXF+YF->1\r\nY=+XF-YFYF--YF-XF++XF+YF<1\r\nF="),
        };
