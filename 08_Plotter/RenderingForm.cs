...
{
    private IList<PlotterCommand> Commands;
    ...
    internal void RefreshPlot(IList<PlotterCommand> commands)
    {
        Commands = commands;
        RefreshPlot();
    }
    ...
    private void RenderingForm_Resize(object sender, EventArgs e)
    {
        if (Commands != null)
            RefreshPlot();
    }
    ...
    private void RenderingForm_FormClosed(object sender, FormClosedEventArgs e)
        => Application.Exit();
}
