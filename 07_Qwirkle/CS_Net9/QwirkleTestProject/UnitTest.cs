...
public class UnitTests_Misc
{
    ...
    public void BagTest()
    {
        ...
        foreach (Shape s in Enum.GetValues<Shape>())
...
public class UnitTests_Evaluate
{
    ...
    public void NotInSameRowOrSameColumn()
    {
        ...
        Debug.Assert(!status);
        Debug.Assert(msg == "Les tuiles jou�es doivent �tre situ�es sur une m�me ligne ou une m�me colonne");
    }
    ...
    public void NotSameShapeOrSameColor()
    {
        ...
        (status, msg) = board.EvaluateMoves(moves);
        Debug.Assert(!status);
        Debug.Assert(msg == "2 couleurs et 2 formes diff�rentes, les tuiles jou�es doivent �tre de la m�me couleur ou de la m�me forme");
    }
    ...
    public void NotOnPlayableCell()
    {
        ...
        (status, msg) = board.EvaluateMoves(moves);
        Debug.Assert(!status);
        Debug.Assert(msg == "La tuile Circle Green #1 en position (48, 50) n'est pas pos�e sur une cellule jouable");
    }
