...
namespace ColorFlow_Solver
{
    static partial class Program
    {
        ...
        static void Main()
        {
            ...
            var n = DateTime.Now;
            using (StreamWriter swu = new StreamWriter(string.Format(@"C:\temp\ColorFlow-{0}-{1:D2}-{2:D2}-{3:D2}.{4:D2}.{5:D2}.txt", n.Year, n.Month, n.Day, n.Hour, n.Minute, n.Second)))
            {
                swu.AutoFlush = true;
                sw = swu;
        ...
        {
            Board(5, new Line[] { new Line(0, 0, 2, 2), new Line(3, 0, 1, 3), new Line(4, 0, 4, 4) });
        ...
        {
            Board(5, new Line[] { new Line(0, 0, 2, 2), new Line(3, 0, 1, 3), new Line(2, 0, 4, 4) });
        ...
        {
            Board(3, new Line[] { new Line(1, 0, 0, 0), new Line(2, 0, 2, 1) });
        ...
        {
            Board(3, new Line[] { new Line(1, 0, 0, 2), new Line(2, 0, 2, 1) });
