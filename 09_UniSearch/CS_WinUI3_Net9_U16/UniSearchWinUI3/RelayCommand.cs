...
public partial class RelayCommand<T>(Action<T> execute, Predicate<T>? canExecute): ICommand, IRaiseCanExecuteChanged
{
    ...
    public bool CanExecute(object? parameter) => _canExecute == null || (parameter == null ? _canExecute(default!) : _canExecute((T)parameter));
