...
public static partial class D2DDrawText
{
    ...
    public static BitmapSource? GetBitmapSource(string s, FontFamily fontFamily)
    {
        byte[] xx = TextToBytesArray(s, fontFamily.Source, 96);
    ...
    public static BitmapSource? CroppedBitmapSourceFromArray(byte[] pixels, int width, int height)
    {
        ...
        var sourceRect = new Int32Rect(left, top, cropWidth, cropHeight);
        var bitmap = new WriteableBitmap(cropWidth, cropHeight, 96, 96, PixelFormats.Bgra32, null);
