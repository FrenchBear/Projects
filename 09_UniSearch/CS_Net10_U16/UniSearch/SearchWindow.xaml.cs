...
// 2020-11-11   PV      1.2 Net5; New rule for 1-letter filters
...
// 2024-12-08   PV      1.16.2 Net9 CS13; Switch font support
...
internal sealed partial class SearchWindow
{
    ...
    public SearchWindow()
    {
        ...
        Loaded += (s, e) =>
        {
            ...
            InsertMenu(systemMenuHandle, 6, MfByposition, SettingsSysMenuId, "&About UniSearch...");
    ...
    {
        if (sender is not TreeView { SelectedItem: CheckableNode cn })
            return;
