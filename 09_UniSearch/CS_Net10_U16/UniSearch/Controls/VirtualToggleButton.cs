...
//
// 2023-01-22   PV      Proper handling of nullable enable
// 2024-09-13   PV      Net8 CS12 U16, moved this file to a subfolder so that namespace matches folder structure
    ...
    private static void OnIsCheckedChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        if (d is UIElement pseudobutton)
        {
            ...
            _ = newValue == true
                ...
                : newValue == false ? RaiseUncheckedEvent(pseudobutton) : RaiseIndeterminateEvent(pseudobutton);
        }
    }
