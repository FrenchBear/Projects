...
// 2023-01-23   PV      1.7   Net7/C#11
// 2023-03-24	PV		1.7.1 Synonyms for names; Text/Emoji font for result; ZWJ and VS15/16 examples
// 2023-03-27   PV      1.8   Emoji attributes from emoji-data.txt; Emoji expansion
// 2023-08-24   PV      2.0   With Search character
...
public sealed partial class MainPage: Page
{
    ...
    private static IList<CodepointDetail> GetCodepointsDetails(ref string s, bool expandEmoji)
    {
        ...
        for (int i = 0; i < s.Length; i++)
        {
            ...
            if (expandEmoji && UniData.CharacterRecords.TryGetValue(cp, out var cr) && cr.IsEmojiXXX)
            {
                ...
                s = s.Substring(0, i0) + n + s.Substring(i+1);
                i = i0+n.Length - 1;
            }
    ...
    private void TextButton_Click(object sender, RoutedEventArgs e)
        => ResultText.FontFamily = new Windows.UI.Xaml.Media.FontFamily("Segoe UI Variable");

    private void EmojiButton_Click(object sender, RoutedEventArgs e)
        => ResultText.FontFamily = new Windows.UI.Xaml.Media.FontFamily("Segoe UI Emoji");
