...
{
    private readonly List<WordPosition> m_WordPositionList = [];
    private readonly Dictionary<int, Square> m_Squares = [];
    ...
    {
        ArgumentNullException.ThrowIfNull(wordPosition);
    ...
    private void AddSquares(WordPosition wordPosition)
    {
        ...
        foreach (char c in wordPosition.Word)
        {
            ...
            {
                var sq = new Square(row, column, c, false, 1);
    ...
    {
        var tempList = new List<WordPosition>(m_WordPositionList);
    ...
    {
        var tempList = new List<WordPosition>(wordPositionList);
        var toExamine = new Stack<WordPosition>();
        var connected = new List<WordPosition>();
