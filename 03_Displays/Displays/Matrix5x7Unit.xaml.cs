...
public partial class Matrix5x7Unit: UserControl
{
    ...
    private static readonly Dictionary<char, byte[]> BmpStyle0 = new()
    {
        ...
        {'\'', new byte[]{ 0x60, 0x20, 0x40, 0x00, 0x00, 0x00, 0x00, } },
        {'(', new byte[] { 0x10, 0x20, 0x40, 0x40, 0x40, 0x20, 0x10, } },
        {')', new byte[] { 0x40, 0x20, 0x10, 0x10, 0x10, 0x20, 0x40, } },
        {'*', new byte[] { 0x00, 0x20, 0xA8, 0x70, 0xA8, 0x20, 0x00, } },
        {'+', new byte[] { 0x00, 0x20, 0x20, 0xF8, 0x20, 0x20, 0x00, } },
        {',', new byte[] { 0x00, 0x00, 0x00, 0x00, 0x60, 0x20, 0x40, } },
        ...
        {'3', new byte[] { 0xF8, 0x10, 0x20, 0x10, 0x08, 0x88, 0x70, } },
        ...
        {';', new byte[] { 0x00, 0x60, 0x60, 0x00, 0x60, 0x20, 0x40, } },
        ...
        {'?', new byte[] { 0x70, 0x88, 0x08, 0x10, 0x20, 0x00, 0x20, } },
