// Grammar for WPF Path Markup Syntax
...
/* Test data
F1 M 10.380 16.015 v -3.83381 c 0 -0.994833 0.806979 -1.80181 1.80181 -1.80181 h 11.1151 c 0.42598 0 0.81756 0.148166 1.12712 0.396875 l 4.55084 -9.82662 c -1.35732 -0.608542 -2.8575 -0.949854 -4.43707 -0.949854 H 10.938 c -6.01663 0 -10.9379 4.92125 -10.9379 10.9379 v 1.03452 z
F1 M 25.093 12.028 c 0.005 0.05027 0.008 0.100542 0.008 0.153458 v 12.4222 c 0.42333 0.10848 0.84402 0.23548 1.26206 0.38364 c 0.97102 0.34396 1.90764 0.7964 2.77812 1.33615 c 0.87577 0.5371 1.67746 1.15623 2.43152 1.82298 c 0.4154 0.37041 0.81492 0.762 1.19857 1.17475 c 0.57943 -0.74877 1.08479 -1.55311 1.49225 -2.41036 c 0.81756 -1.7145 1.21973 -3.61685 1.21708 -5.51391 V 10.938 c 0 -4.03754 -2.21721 -7.58031 -5.4954 -9.47473 Z
F1 M 32.768 31.065 c -0.381 0.41275 -0.78052 0.80698 -1.19856 1.17475 c -0.75406 0.66675 -1.55575 1.28588 -2.43152 1.82298 c -0.87048 0.5371 -1.80711 0.99219 -2.77813 1.33615 c -0.41539 0.14816 -0.83873 0.27516 -1.26206 0.38364 v 15.6316 c 0 0.0185 0 0.0344 -0.003 0.0529 l 4.87098 10.6733 c 3.28613 -1.89177 5.51127 -5.43983 5.51127 -9.48531 v -13.6657 c 0 -1.89706 -0.39952 -3.79941 -1.21708 -5.51391 c -0.40746 -0.85725 -0.91281 -1.66159 -1.49225 -2.41036 z
F1 M 24.458 52.795 c -0.31221 0.26458 -0.71702 0.42333 -1.15888 0.42333 H 12.184 c -0.994833 0 -1.80181 -0.80698 -1.80181 -1.80181 V 47.583 l -10.3796 4.04283 v 1.03452 c 0 6.01663 4.92125 10.9379 10.9379 10.9379 H 24.540 c 1.57162 0 3.06387 -0.33867 4.41854 -0.93927 l -4.50056 -9.86102 z
...
path:   fillrule? figureDescription+ EOL+;

fillrule: 'F0'|'F1';

figureDescription: moveCommand drawCommand+ closeCommand? ;

closeCommand: 'z' | 'Z';

moveCommand: ('m'|'M') point;
...
drawCommand:
    ...
    | smoothCubicBezierCurveCommand
    | smoothQuadraticBezierCurveCommand
    | ellipticalArcCommand
    ;
    
lineCommand: ('l'|'L') point+;

horizontalLineCommand: ('h'|'H') FLOAT+;

verticalLineCommand: ('v'|'V') FLOAT+;

cubicBezierCurveCommand: ('c'|'C') (point point point)+;

quadraticBezierCurveCommand: ('q'|'Q') point point;

smoothCubicBezierCurveCommand: ('s'|'S') point point;

smoothQuadraticBezierCurveCommand: ('t'|'T') point;

ellipticalArcCommand: ('a'|'A') (size=FLOAT rotationAngle=FLOAT isLargeArcFlag=FLOAT sweepDirectionFlag=FLOAT endPoint=point)+;
